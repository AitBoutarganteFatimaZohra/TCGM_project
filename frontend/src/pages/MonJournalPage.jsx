...
// Le Magasinier n'agit que sur les ressources : pas besoin des types
// SITE/OUVRIER/CLIENT/etc. ni de VALIDATION (il ne valide rien).
const ACTION_TYPES = ['CREATION', 'MODIFICATION', 'SUPPRESSION'];
...
const MonJournalPage = () => {
  ...
  const buildParams = useCallback(
    ...
    [page, selectedSiteId, search, actionType, startDate, endDate]
  );
  ...
  return (
    <div className="journal-page">
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
          {sites.length > 1 && (
            <select
              ...
              onChange={(e) => { setPage(0); setSelectedSiteId(Number(e.target.value)); }}
            >
      ...
      {loading ? (
        ...
        <div className="empty-state"><p>Aucune opération enregistrée pour ce site.</p></div>
      ) : (
        <div className="table-container">
          <table className="ouvriers-table">
            <thead>
              <tr>
                <th>Date</th><th>Action</th><th>Élément concerné</th>
